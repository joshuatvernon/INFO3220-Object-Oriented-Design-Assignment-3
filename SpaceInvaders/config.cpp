...
QSet<QString> Config::getManualInstructions() {
    return manualInstructions;
}

void Config::addManualInstruction(QString ins) {
    manualInstructions.insert(ins);
}

void Config::removeManualInstruction(QString ins) {
    manualInstructions.remove(ins);
}

void Config::clearManualInstructions() {
    manualInstructions.clear();
}
